    ...
    <div className="flex overflow-x-auto border-b border-neutral-800 bg-neutral-950">
      {openFiles.map((path) => {
        ...
        return (
          <div
            key={path}
            className={`flex cursor-pointer items-center gap-1 border-r border-neutral-800 px-3 py-1.5 text-xs ${isActive ? 'bg-neutral-900 text-white' : 'text-neutral-500 hover:text-neutral-300'}`}
